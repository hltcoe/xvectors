...
#CODEBASE="/home/hltcoe/amccree/src/pytorch-xvec/Releases/ver2_2"
...
#LOCAL_DIR='/scratch/dgromero/tmp_folder_wb_fb80'
LOCAL_DIR=''
#UTT2SPK='utt2spk_vox2_only'
UTT2SPK='utt2spk'
...
#VALID_OPTS="$VALID_OPTS --valid_only "
